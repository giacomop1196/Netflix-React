                ...
                <Container>
                    <Row className="mb-4">
                        <Col xs={12} className="text-center text-md-start">
                            <a href="https://www.facebook.com/?locale=it_IT" target="_blank" rel="noopener noreferrer" className="me-3 text-white-50">
                            ...
                            <a href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" className="text-white-50">
